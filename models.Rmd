...
```
* note that top 5 have rmse = 3.0 to 2 sf
* top 32 - 3.1 to 2 sf
* top 64 - 3 to 1 sf
* no big differences, so best models will give pretty much the same values for predicted number of medals (differences likely to be more visible when number of medals is low)
* half of the models have average deviation from the real number of total medals won of 3 medals
...
* average error for teams with more than 10 medals is 18.4%
* rmse is 5.2, or 22.6% of mean, which is a worse fit than for Summer Olympics
...
* number of athletes, as expected, is present in all models with rmse = 3 to 1 sf
* models without nu_athletes have rmse of at least 30
